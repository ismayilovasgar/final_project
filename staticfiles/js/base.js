...
//   // Damcının üfüqi mövqeyini təsadüfi olaraq təyin edin
//   drop.style.left = Math.random() * window.innerWidth + "px";

//   // Təsadüfi düşmə müddəti
//   drop.style.animationDuration = Math.random() * 2 + 2 + "s"; // 2-4 saniyə

//   document.getElementById("mydrops").appendChild(drop);

//   // Damcı ekranın altına çatdıqda silinsin
//   setTimeout(() => {
//     drop.remove();
//   }, 4000); // Təxminən 4 saniyədən sonra silinir
// }

// // Damcıların davamlı yaradılması
// // Hər 100ms-də bir damcı yaradır
// setInterval(createDrop, 100);

function createDrop() {
  const drop = document.createElement("img"); // Yeni bir img elementi oluştur
  drop.classList.add("mydrop"); // CSS sınıfını ekle
